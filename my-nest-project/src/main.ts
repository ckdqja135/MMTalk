...
async function bootstrap() {
  ...
  //   {
  //     "weekNumber": 10,
  //     "content": "Before having any food, check to see if it's safe to consume during pregnancy. "
  //   },
  //   {
  //     "weekNumber": 10,
  //     "content": "Consider implenting a new diet plan to increase calcium consumption. "
  //   },
  //   {
  //     "weekNumber": 11,
  //     "content": "Ask your doctor about which medication is safe to take during pregnancy. "
  //   },
  //   {
  //     "weekNumber": 11,
  ...
  //   {
  //     "weekNumber": 13,
  //     "content": "Look for symptoms of UTIs, such as itchiness or burning sensation. "
  //   },
  //   {
  //     "weekNumber": 13,
  ...
  //   {
  //     "weekNumber": 14,
  //     "content": "Ask your doctor about if you need any supplements and medications. "
  //   },
  //   {
  //     "weekNumber": 14,
  ...
  //   {
  //     "weekNumber": 15,
  //     "content": "Talk to your doctor about morning sickness if the symptom is severe. "
  //   },
  //   {
  //     "weekNumber": 16,
  ...
  //   {
  //     "weekNumber": 19,
  //     "content": "Consider purchasing a seatbelt extender designed for pregnant women. "
  //   },
  //   {
  //     "weekNumber": 19,
  //     "content": "Create a weight increase chart to see the trend. "
  ...
  //   {
  //     "weekNumber": 20,
  //     "content": "Research if there's any remedy for reducing the appearance of stretch marks. "
  //   },
  //   {
  //     "weekNumber": 21,
  //     "content": "Designate a few minutes each day and communicate with your baby. "
  //   },
  //   {
  //     "weekNumber": 21,
  //     "content": "Consult a doctor if your belly feels tight and painful frequently. "
  //   },
  //   {
  //     "weekNumber": 21,
  //     "content": "Research if there's any class available in your area about breastfeeding. "
  //   },
  //   {
  //     "weekNumber": 22,
  ...
  //   {
  //     "weekNumber": 23,
  //     "content": "Choose skin care products that are designed for sensitive skin type or pregnant women. "
  //   },
  //   {
  //     "weekNumber": 24,
  ...
  //   {
  //     "weekNumber": 25,
  //     "content": "Learn about different breathing methods you can use during labor. "
  //   },
  //   {
  //     "weekNumber": 25,
  ...
  //   {
  //     "weekNumber": 29,
  //     "content": "Massage your belly with oil or cream to help reduce the appearance of strech marks. "
  //   },
  //   {
  //     "weekNumber": 29,
  ...
  //   {
  //     "weekNumber": 31,
  //     "content": "Apply sunscreen regularly as your skin can become sensitive during pregnancy. "
  //   },
  //   {
  //     "weekNumber": 31,
  ...
  //   {
  //     "weekNumber": 34,
  //     "content": "Create your own checklist and start preparing for the birth of your baby. "
  //   },
  //   {
  //     "weekNumber": 34,
  ...
  //   {
  //     "weekNumber": 35,
  //     "content": "Birth ball exercise can help induce the baby to move their head down. "
  //   },
  //   {
  //     "weekNumber": 35,
  ...
  //   {
  //     "weekNumber": 37,
  //     "content": "Review each delivery method and determine if you'd like to induce labor. "
  //   },
  //   {
  //     "weekNumber": 37,
  //     "content": "Consider downloading the contraction timer app on your phone to prepare for labor. "
  //   },
  //   {
  //     "weekNumber": 38,
